...
class LoginPageLocators():
    BTN_REGISTER_USER = (By.NAME, "registration_submit")
    PASSWORD1_REGISTER = (By.CSS_SELECTOR, "#id_registration-password1")
    PASSWORD2_REGISTER = (By.CSS_SELECTOR, "#id_registration-password2")
